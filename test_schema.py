...
def my_super_cool_function(x_int: int, y_str: str, z_float: float = 3.14) -> str:
    """This is a super cool function that does amazing things."""
    return f"Result: {x_int} + {y_str} + {z_float}"
...
if __name__ == "__main__":
    ...
    print("Testing my_super_cool_function schema:")
    schema1 = generate_schema(my_super_cool_function)
    print(json.dumps(schema1, indent=2))
    
    print("\n" + "="*50 + "\n")
    
    print("Testing my_unique_addition schema:")
    schema2 = generate_schema(my_unique_addition)
